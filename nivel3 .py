...
#--------cuarto punto-------- 
#utilice el bucle while para que cuente de 10 a 0
#y la i la inicie en 10 para que empiece desde ahi y luego le reste 1 hasta que llegue a 0
i= 10
while i >= 0:
    print(i)
    i -= 1
...
#utilice el modulo random para generar un numero aleatorio entre 1 y 10
import random 
print ("Adivina el numero entre 1 y 10")
numero_secreto = int(random.randint(1, 10))
#utilice un bucle while para que el usuario pueda seguir intentando adivinar el numero hasta que lo logre
while True:
...
#-------sexto punto-------
#utilice estas variables para mas adelante poder sumar los numeros ingresados por el usuario
#y la while true para que el usuario pueda ingresar numeros hasta que ingrese un 0 y ahi se detenga el bucle
suma= 0 
numero = 0 
while True:
